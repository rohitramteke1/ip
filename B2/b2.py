...
# a png image
cv2.imwrite('Person_Negative.png', img_neg)
...
cv2.imwrite('Person_Thresh.png', img_thresh)
...
# Convert array to png image
cv2.imwrite('Person_Thresh_Back.png', img_thresh_back)

cv2.imshow('Negative',img_neg)
cv2.imshow('Thres',img_thresh)
cv2.imshow('ThresBack',img_thresh_back)
cv2.waitKey(5000)
